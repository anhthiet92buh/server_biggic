...
type MainServiceClient interface {
	MainKeyWord(ctx context.Context, in *KeyWordC, opts ...grpc.CallOption) (*KeyWordS, error)
}
...
func (c *mainServiceClient) MainKeyWord(ctx context.Context, in *KeyWordC, opts ...grpc.CallOption) (*KeyWordS, error) {
	out := new(KeyWordS)
...
type MainServiceServer interface {
	MainKeyWord(context.Context, *KeyWordC) (*KeyWordS, error)
...
func (UnimplementedMainServiceServer) MainKeyWord(context.Context, *KeyWordC) (*KeyWordS, error) {
...
func _MainService_MainKeyWord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MainServiceServer).MainKeyWord(ctx, req.(*KeyWordC))
	}
...
var MainService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/mainService.proto",
}
